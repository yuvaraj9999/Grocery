...
namespace SmartStore.Web.Controllers
{
    public partial class CommonController : PublicControllerBase
    {
        ...
        public ActionResult Footer()
        {
            ...
            model.SmartStoreHint = "<a href='https://www.myvillagekart.com/' class='sm-hint' target='_blank'><strong>{0}</strong></a>&copy; {1}"
                .FormatCurrent("My Village Kart", DateTime.Now.Year);
